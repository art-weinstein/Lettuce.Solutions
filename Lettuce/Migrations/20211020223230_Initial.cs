    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LettucePlants", x => x.LettucePlantId);
                    table.ForeignKey(
                        name: "FK_LettucePlants_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BrandLettucePlantId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    BrandId = table.Column<int>(type: "int", nullable: false),
                    LettuceId = table.Column<int>(type: "int", nullable: false),
                    LettucePlantId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrandLettucePlants", x => x.BrandLettucePlantId);
                    table.ForeignKey(
                        name: "FK_BrandLettucePlants_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "BrandId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BrandLettucePlants_LettucePlants_LettucePlantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BrandLettucePlants_BrandId",
                table: "BrandLettucePlants",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_BrandLettucePlants_LettucePlantId",
                table: "BrandLettucePlants",
